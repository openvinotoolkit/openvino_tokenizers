...
SO_TARGET_VERSION = 70.1
SO_TARGET_VERSION_MAJOR = 70
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt70
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt70 
ICUDATA_CHAR = l
...
CFLAGS = -O3  -Wno-undef -std=c11 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) 
# CXXFLAGS is for C++ only flags
CXXFLAGS = -O3   -Wno-suggest-override -Wno-undef --std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 -O3 -fPIC -ldl -lpthread -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long $(THREADSCXXFLAGS) 
