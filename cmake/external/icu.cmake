...
set(ICU_UC_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_UC_LIB_NAME}${ICU_SUFFIX}${ICU_${TYPE}_SUFFIX}")
set(ICU_I18N_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_I18N_LIB_NAME}${ICU_SUFFIX}${ICU_${TYPE}_SUFFIX}")
set(ICU_DATA_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_DATA_LIB_NAME}${ICU_SUFFIX}${ICU_${TYPE}_SUFFIX}")
...
set(ICU_DATA_SHARED_LIB "${ICU_SHARED_LIB_DIR}/${ICU_SHARED_PREFIX}${ICU_DATA_SHARED_LIB_NAME}${ICU_SUFFIX}${ICU_SHARED_SUFFIX}")
...
if(WIN32)
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND msbuild ${ICU_SOURCE_DIR}\\source\\allinone\\allinone.sln /p:OutDir=${ICU_BINARY_DIR} /p:Configuration=${ICU_BUILD_TYPE} /p:Platform=x64 /p:SkipUWP=true /t:common /t:i18n /t:uconv /t:makedata 
    BUILD_COMMAND ""
