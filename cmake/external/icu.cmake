...
if(WIN32)
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND msbuild ${ICU_SOURCE_DIR}\\source\\allinone\\allinone.sln /p:OutDir=${ICU_BINARY_DIR} /p:Configuration=${ICU_BUILD_TYPE} /p:Platform=x64 /p:SkipUWP=true /t:i18n /t:uconv /t:makedata 
    BUILD_COMMAND ""
