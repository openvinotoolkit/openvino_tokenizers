...
set(ICU_UC_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_UC_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_${TYPE}_SUFFIX}")
set(ICU_I18N_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_I18N_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_${TYPE}_SUFFIX}")
set(ICU_DATA_LIB "${ICU_${TYPE}_LIB_DIR}/${ICU_${TYPE}_PREFIX}${ICU_DATA_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_${TYPE}_SUFFIX}")

set(ICU_UC_SHARED_LIB "${ICU_SHARED_LIB_DIR}/${ICU_SHARED_PREFIX}${ICU_UC_SHARED_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_SHARED_SUFFIX}")
set(ICU_I18N_SHARED_LIB "${ICU_SHARED_LIB_DIR}/${ICU_SHARED_PREFIX}${ICU_I18N_SHARED_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_SHARED_SUFFIX}")
set(ICU_DATA_SHARED_LIB "${ICU_SHARED_LIB_DIR}/${ICU_SHARED_PREFIX}${ICU_DATA_SHARED_LIB_NAME}${CMAKE_DEBUG_POSTFIX}${ICU_SHARED_SUFFIX}")
